<?php get_header(); ?>
    <section>
        ...
        <div class="row full collapse" id="contenedor_nosotros">
            <div class="large-12 medium-12 small-12 columns">
                <div class="large-6 medium-6 small-12 columns contenedor_img">
                    <img src="<?php bloginfo('template_directory'); ?>/img/img_rancho.jpg" alt="">
                </div>
                <div class="large-6 medium-6 small-12 columns">

                    <div class="texto">
                        <h5>Patrimonio arquitectónico rural</h5>
                        <h2>Puestos y ranchos <br>
                            de Magallanes </h2>
                        ...
                        <p>
                          A través de esta plataforma web podrás buscar información sobre puestos y ranchos de Magallanes y a su vez podrás aportar información sobre éstos utilizando la ficha catastral que se encuentra disponible en la sección <a href="<?php bloginfo("url")?>/agregar-ficha">Ficha Catastral.</a> 
                        </p>
        ...
        <div class="row full" id="contenedor_puestos_ranchos">
            ...
            <div class="large-12 medium-12 small-12 columns">
                <div class="text-center">
                    <a href="#" class="button">Ver más puestos y ranchos</a>
                </div>
            </div>
        </div>
    </section>

                ...
                <div class="row">
                    <div class="texto_interior">
                        ...
                        <div class="large-6 medium-6 small-12 columns">
                            <div class="titulo">
                                <h3><i class="fa-solid fa-location-dot"></i> Límite</h3> <span class="rancho">Rancho</span>

                                <h5 class="otros_nombres">Otros nombres</h5>
                            </div>
                            <p>Memoria histórica: Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut pers</p>
                        </div>
                    ...
                    <div class="texto_interior text-center">
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th width="500">Dimenciones:</th>
                                    <td>x</td>
                                </tr>
                                <tr>
                                    <th width="500">Habitabilidad actua:</th>
                                    <td>-</td>
                                </tr>
                                <tr>
